            ...
            <div className="pt-4 border-t border-outline-variant/20">
              ...
              <div className="p-4 rounded-2xl flex items-center justify-between border border-primary/40 bg-primary/10 text-primary shadow-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="font-bold text-sm text-on-surface block">Direct Request to Seller</span>
                    <span className="text-xs text-on-surface-variant">No online payment required. Request sent directly to seller.</span>
                  </div>
                </div>
